"use strict";
(self["webpackChunkweb_tide"] = self["webpackChunkweb_tide"] || []).push([["vendors-node_modules_babylonjs_core_Materials_Textures_Loaders_basisTextureLoader_js"],{
        ...
        _WorkerPromise = new Promise((res, reject) => {
            if (_Worker) {
                ...
                _tools_js__WEBPACK_IMPORTED_MODULE_0__.Tools.LoadFileAsync(_tools_js__WEBPACK_IMPORTED_MODULE_0__.Tools.GetBabylonScriptURL(BasisToolsOptions.WasmModuleURL))
                    ...
                    (0,_basisWorker_js__WEBPACK_IMPORTED_MODULE_3__.initializeWebWorker)(_Worker, wasmBinary, BasisToolsOptions.JSModuleURL).then(res, reject);
                })
                    .catch(reject);
            }
        });
...
//# sourceMappingURL=vendors-node_modules_babylonjs_core_Materials_Textures_Loaders_basisTextureLoader_js.js.map